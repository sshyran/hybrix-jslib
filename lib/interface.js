 ...
 */
  ...
  this.save = function(data, dataCallback, errorCallback,progressCallback){
    if(typeof data !== 'object'){
      ...
      this.call({host:data.host,query:'/e/storage/set/'+encodeURIComponent(legacy(data.key))+'/'+encodeURIComponent(JSON.stringify(data.value)),channel:data.channel},dataCallback , errorCallback,progressCallback);
    }else{
      this.sequential([
  ...
  this.load = function(data, dataCallback, errorCallback,progressCallback){
    if(typeof data !== 'object'){
      ...
      this.call({host:data.host,query:'/e/storage/get/'+encodeURIComponent(legacy(data.key)),channel:data.channel,meta:data.meta}, (data)=>{
        dataCallback(decodeURIComponent(data));
      },errorCallback,progressCallback);
    }else{
      this.sequential([
