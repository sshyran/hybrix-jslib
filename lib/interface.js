...
/**
 * Internet of Coins main API interface object. It connects to servers running Internet of Coins hybrixd using the REST API.  For reference: [hybrixd API]{@link https://wallet1.internetofcoins.org/api/help}
 ...
 * @example
 * // Node JS
 * var hybrixd = require('./hybrixd.interface.nodejs');
 *
 ...
 * }
 *
 * hybrixd.init(null, onSucces, onError);
 * @example
 * <!-- Webpage -->
 * <script src="./hybrixd.interface.web.js"></script> to html header
 * <script>
 * var hybrixd = new hybrixd.Interface({XMLHttpRequest:XMLHttpRequest});
 *
 * function onSucces(){
 *  console.error('Done.');
 * }
 ...
 * @category Host
 * @param {Object} data
 * @param {string} data.query - The query path. For reference: [hybrixd API]{@link https://wallet1.internetofcoins.org/api/help}
 * @param {string} [data.channel] - Indicate the channel 'y' for encryption, 'z' for both encryption and compression
