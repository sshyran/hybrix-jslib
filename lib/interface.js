 ...
 */
  ...
  /**
 * Creates a raw transaction that is signed but not yet pushed to the network.
 * @category Transaction
 * @param {Object} data
 * @param {string} data.symbol - The symbol of the asset
 * @param {string} data.target - The target address
 ...
 */
  ...
  /**
 * Create, sign and execute a transaction e.g. push it into the netwerol.
 * @category Transaction
 * @param {Object} data
 * @param {string} data.symbol - The symbol of the asset
 * @param {string} data.target - The target address
 ...
 */
  this.addHost = function (data, dataCallback, errorCallback) {
    ...
    if (
      ...
      fail('Host not valid hostname, IPv4, or relative path : "' + data.host + '"  expected: "[protocol://hostnameOrIPv4Address[:portnumber]][/path]/"');
    } else {
